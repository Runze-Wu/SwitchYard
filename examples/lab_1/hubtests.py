...
def hub_tests():
    ...
    testpkt = mk_pkt("30:00:00:00:00:02", "ff:ff:ff:ff:ff:ff", "172.16.42.2",
                     "255.255.255.255")
    s.expect(
    ...
    reqpkt = mk_pkt("20:00:00:00:00:01", "30:00:00:00:00:02", '192.168.1.100',
                    '172.16.42.2')
    s.expect(
    ...
    resppkt = mk_pkt("30:00:00:00:00:02",
                     "20:00:00:00:00:01",
                     '172.16.42.2',
                     '192.168.1.100',
                     reply=True)
    ...
    s.expect(
        ...
        "Ethernet frame destined to 20:00:00:00:00:01 should be flooded out eth0 and eth2"
    )

    # test case 3: a frame with dest address of one of the interfaces should
    # result in nothing happening
    reqpkt = mk_pkt("20:00:00:00:00:01", "10:00:00:00:00:03", '192.168.1.100',
                    '172.16.42.2')
    s.expect(
    ...
    #result in nothing happening
    reqpkt = mk_pkt("20:00:00:00:00:01", "20:00:00:00:00:01", '172.16.42.2',
                    '172.16.42.2')
    s.expect(
        PacketInputEvent("eth0", reqpkt, display=Ethernet),
    ...
    # the packet can't return to the send port
    # s.expect(
    #     PacketInputEvent("eth0", reqpkt, display=Ethernet),
